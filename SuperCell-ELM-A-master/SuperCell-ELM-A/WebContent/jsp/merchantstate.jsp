      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="../merchantmanage/getmerchantstate.do">商户管理</a></li>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>${msg.merchantId}</td>
				<td>${msg.merchantStateText}</td>
			<td><a href="../merchantmanage/getinfo.do?id=${msg.merchantId}&state=${msg.merchantState}"><Button class="btn btn-primary">查看详情</Button></a></td>
				</c:forEach>
              </tbody>
            </table>
          </div>
